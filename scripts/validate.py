...
EXPECTED_BASE = "runpod/comfyui:1.3.2-comfyuiv0.30.0-cuda12.8"
EXPECTED_IMAGE = "coohh88/runpod-comfyui-128"
...
assert "pip install --no-build-isolation cupy-cuda12x;" in dockerfile
assert "pip install --no-build-isolation cupy-cuda13x;" not in dockerfile
